...
.banner {
  ...
  color: white; /* Warna teks utama (warna warning) */
  text-align: start;
  padding: 20px;
  text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.6),
               -1px -1px 2px rgba(255, 255, 255, 0.3); /* Shadow lebih keren */
}
...
.carousel-inner {
display: flex; /* Membuat elemen di dalamnya berjajar horizontal */
overflow: hidden;
}
.carousel-item {
flex: 0 0 100%; /* Setiap item mengambil 100% dari lebar carousel */
display: flex; /* Agar konten di dalam carousel-item bisa diatur dengan flexbox */
...
background-size: 100%;   /* Sesuaikan ukuran ikon */
border-radius: 50%;      /* Opsional, untuk membuat lingkaran */
}
...
.cards-wrapper {
display: flex; /* Untuk membuat kartu di dalam wrapper berjajar horizontal */
...
.fixed-image {
    width: 100%;
    height: 300px; /* Konsistensi tinggi gambar */
            ...
            @foreach($barangSewa as $item)
              <div class="item mb-4">
                  <div class="card h-100 fixed-image-wrapper">
                      <!-- Gambar -->
                      <img
                          src="{{ env('APP_ASSET') . $item->image_url }}"
